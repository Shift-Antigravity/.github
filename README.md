...
| 対象者 | ドキュメント | 内容 |
| :--- | :--- | :--- |
| **室長・管理者** | [室長用マニュアル](./Admin_Manual/Admin_Manual.md) | シフトの発行、集計、塾マネへの反映方法など |
| **講師** | [講師用マニュアル](./Tutor_Manual/Tutor_Manual.md) | アカウント作成、シフトの提出方法など |
...
特に今回はSeleniumではなく拡張機能を用いることで効率的にかつ安定、継続的な運用が可能になっています。また提出状況を確認しながら入力が行えることが利点です。
